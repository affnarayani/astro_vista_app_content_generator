...
def main():
    ...
    with open('today_horoscope.json', 'r') as file:
    ...
    with open('modified_today_horoscope.json', 'w') as file:
        json.dump(horoscope_data, file, indent=4)
    
    print("\nAll horoscopes successfully modified and saved to 'modified_today_horoscope.json'")
