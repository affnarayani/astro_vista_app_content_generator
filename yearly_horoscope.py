...
def get_yearly_horoscope(zodiac_sign):
    """
    Fetch yearly horoscope for the given zodiac sign from ProKerala website.
    ...
    # Construct the URL
    url = f"https://www.prokerala.com/astrology/yearly-horoscope/{zodiac_sign}.html"
...
def main():
    ...
    for i, sign in enumerate(zodiac_signs):
        ...
        horoscope_data, _ = get_yearly_horoscope(sign)
    ...
    # Save to JSON file
    with open('yearly_horoscope.json', 'w', encoding='utf-8') as f:
