...
def extract_date_from_title(soup):
    ...
    # Example: "Tomorrow's Leo Horoscope - Monday, May 12, 2025"
...
def get_horoscope(zodiac_sign):
    ...
    # Construct the URL
    base_url = f"https://www.prokerala.com/astrology/horoscope/?sign={zodiac_sign}&day=tomorrow"
...
def main():
    ...
    if extracted_date:
        ...
        # Save to JSON file
        with open('tomorrow_horoscope.json', 'w', encoding='utf-8') as f:
            json.dump(horoscope_json, f, indent=4, ensure_ascii=False)
        
        print(f"\nHoroscope data for date {extracted_date} has been saved to tomorrow_horoscope.json")
    else:
